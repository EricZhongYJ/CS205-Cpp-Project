...
// If you want to get a totally random matrix, please use function rand_matrix like line 28.
...
// WITH_SHOW:
    ...
    rand_matrix_seed(mats[0], 100.f, 16, 16, 1);
    rand_matrix_seed(mats[1], 100.f, 16, 16, 2);
